...
> **USER-CONFIRMED DIRECTION (2026-07-20):** Evolve the app's existing **teal** identity — do NOT
> adopt the generated blue/emerald palette below. The canonical tokens live in
> `src/renderer/src/index.css` `:root`. Refine surfaces/contrast/glows, keep the teal accent.

| Role | Hex | CSS Variable |
|------|-----|--------------|
| Accent (teal) | `#2DD4BF` | `--accent` |
| Background base | `#080B10` | `--bg-base` |
| Surface | `#0F1623` | `--bg-surface` |
| Elevated | `#161D2E` | `--bg-elevated` |
| Border | `rgba(255,255,255,0.07)` | `--border` |
| Income | `#34D399` | `--income` |
| Expense | `#F87171` | `--expense` |
| Balance | `#60A5FA` | `--balance` |
| Savings | `#A78BFA` | `--savings` |
| Warning | `#FBBF24` | `--warning` |
| Text primary | `#E6EDF3` | `--text-primary` |
| Text secondary | `#8B9BB4` | `--text-secondary` |
| Text muted | `#4B5568` | `--text-muted` |

**Color Notes:** Dark glassmorphism fintech; teal accent with soft glows; semantic income/expense/balance/savings colors.

### Typography

> **USER-CONFIRMED:** IBM Plex Sans (UI) + IBM Plex Mono (amounts, tables, file paths, chart axes — use `font-variant-numeric: tabular-nums`). Not Fira.

- **Body/UI Font:** IBM Plex Sans
- **Data/Mono Font:** IBM Plex Mono
- **Mood:** financial, trustworthy, precise
...
## Staged Overhaul Roadmap (branch `ui-ux-overhaul`)
